...
ALLOWED_HOSTS = ["projeto6sitescomdjango-production.up.railway.app", "localhost", "127.0.0.1"]
...
DATABASE_URL = 'postgresql://postgres:ntOXlt6Lfk5v610YUxGu@containers-us-west-151.railway.app:7151/railway'
if DATABASE_URL:
    DATABASES = {
